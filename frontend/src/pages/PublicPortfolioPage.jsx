...
export default function PublicPortfolioPage() {
  ...
  useEffect(() => {
    ...
    const description = data.settings?.seoDescription || data.sections?.hero?.intro || copy.metaDefaultDescription;
  ...
  }, [copy.metaDefaultDescription, copy.metaDefaultTitle, data, username]);
  ...
  const socialLinks = useMemo(() => ([
    contact.website ? { label: 'Website', href: contact.website, icon: Globe } : null,
    contact.github ? { label: 'GitHub', href: contact.github, icon: Github } : null,
    contact.linkedin ? { label: 'LinkedIn', href: contact.linkedin, icon: Briefcase } : null,
    contact.telegram ? { label: 'Telegram', href: contact.telegram, icon: Send } : null,
          ...
          <section id="home" className="human-hero">
            <Panel className="human-hero__main">
              ...
              <div className="human-hero__profession">
                <Briefcase size={16} />
                {hero.profession || copy.defaultProfession}
              </div>

              <p className="human-lede">
                {hero.intro || hero.about || copy.defaultIntro}
              </p>
